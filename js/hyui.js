$(function () {
  ...
  $('table').each(function (index, el) {
    //判斷沒有table_list
    if ($(this).parents('.table_list').length == 0 && $(this).parents('.fix_th_table').length == 0 && $(this).parent('form').length == 0 && $(this).parents('.cp_table').length == 0 && $(this).parents('.preview_group').length == 0 && $(this).parents('.secretary_mailbox').length == 0) {
      $(this).scroltable();
    }
  });
